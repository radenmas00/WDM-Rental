...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style="background: linear-gradient(rgba(19, 58, 98, .9), rgba(19, 58, 98, .9)), url(images/page-header.jpg) center center; background-size: cover;">
    <div class="container py-5">
        <h1 class="display-4 animated slideInDown mb-4">Barang & Jasa</h1>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-7 wow fadeInUp ps-0" data-wow-delay="0.5s">
                <div class="heading-section mb-5 heading-section-with-line">
                    <span class="subheading ms-4">PRODUK & PELAYANAN - Barang & Jasa</span>
                </div>
    ...
    <div class="container">
        <div class="row mb-5 pb-3 justify-content-center">
            <div class="col-md-9 heading-section heading-section-with-line">
                <span class="subheading">Barang & Jasa</span>
                <small class="text-muted">Menampilkan <?= $jmlbarangjasa ?> Barang & Jasa yang kami sediakan.</small>
            </div>
        </div>
        <div class="row g-4">
            <?php foreach ($barangjasa as $row) : ?>
                <div class="col-lg-4 col-md-6 wow fadeInUp d-flex align-items-stretch" data-wow-delay="0.1s">
                    <div class="card rounded-0 shadow w-100 border-0 h-100">
                        <a href="barangjasa-<?= $row['judul_seo'] . "-" . $row['id_barangjasa'] ?>"><img src="images/barangjasa/<?= $row['gambar'] ?>.webp" class="card-img-top rounded-0" alt="..." style="aspect-ratio:4/3; object-fit:cover; object-position:center;"></a>
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><a href="barangjasa-<?= $row['judul_seo'] . "-" . $row['id_barangjasa'] ?>"><?= $row['judul'] ?></a></h5>
                            ...
                            <div class="mt-auto">
                                <hr>
                                <a href="barangjasa-<?= $row['judul_seo'] . "-" . $row['id_barangjasa'] ?>" class="btn btn-blue-outline px-4">Lihat Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
