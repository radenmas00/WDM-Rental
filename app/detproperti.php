    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="properti">Properti</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 wow fadeInUp pe-lg-4" data-wow-delay="0.1s">
                <img src="images/properti/<?= $data['gambar'] ?>" alt="" class="img-fluid w-100 mb-4">
                ...
                <h2 class="mb-2 text-blue-primary"><?= $data['judul'] ?></h2>
                <h3 class="mb-3"><?= $data['harga'] ?></h3>
                <hr>
                <div>
                    <?= $data['deskripsi'] ?>
                </div>
                <a href="https://api.whatsapp.com/send?phone=<?= $deskrip[7] ?>&text=Halo <?= $namaweb ?>, Saya mau ingin informasi lebih lanjut tentang info properti *<?= $data['judul'] ?>*." target="_blank" class="btn btn-blue-outline px-5"><i class="fab fa-whatsapp"></i> Hubungi Kami</a>
                <hr>
            ...
            <div class="col-lg-4 wow fadeInUp pt-0 px-sm-0 ms-sm-0 me-sm-0" data-wow-delay="0.5s">
                <div class="sidebar-box shadow">
                    <h3 class="text-blue-primary">Properti Lainnya</h3>
                    <?php foreach ($properti as $row) : ?>
                        <div class="block-21 mb-4 d-flex justify-content-between">
                            <a href="properti-<?= $row['judul_seo'] . "-" . $row['id_properti'] ?>" class="blog-img mr-4" style="background-image: url(images/properti/<?= $row['gambar'] ?>.webp);"></a>
                            <div class="text justify-content-between">
                                <h3 class="heading"><a href="properti-<?= $row['judul_seo'] . "-" . $row['id_properti'] ?>"><?= $row['judul'] ?></a></h3>
                                <div class="meta">
