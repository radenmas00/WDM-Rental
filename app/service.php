...
<section class="uni-banner" style="background-image: url('images/sizechart/<?= $data['gambar'] ?>.webp');">
    <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="portfolio-details ptb-100">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="details-page-text-area">
                                    <div class="portfolio-details-main-img text-center">
                                        <img src="images/sizechart/<?= $data['gambar'] ?>.webp" alt="image">
                                    </div>
                                    <h3><? $data['nama'] ?></h3>
                                    <?= $data['deskripsi'] ?>
                                </div>
