                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="feature-card" style="background: aliceblue;box-shadow: 3px 4px 5px 0px rgba(29,40,75,0.75); -webkit-box-shadow: 3px 4px 5px 0px rgba(29,40,75,0.75); -moz-box-shadow: 3px 4px 5px 0px rgba(29,40,75,0.75);">
                            <div class="feature-card-img">
                                <a href="konsultan-perizinan-<?= $row['judul_seo'] ?>-<?= $row['id_sizechart'] ?>">
                                <div class="artikle" style="background-image: url('images/sizechart/<?= $row['gambar'] ?>.webp'); background-size: cover; background-position: center; background-repeat: no-repeat"></div>
                            ...
                            <div class="features-card-text">
                                ...
                                <h4><a href="konsultan-perizinan-<?= $row['judul_seo'] ?>-<?= $row['id_sizechart'] ?>"><?= $row['nama'] ?></a></h4>
