<?php $this->layout('template', ['hal'=>'List Project']) ?>
<?php
	$module = 'listproject';
	switch($act){
		case "list":
                    ...
                    <table id="my_table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="23%" class="center">Project</th>
                                <th width="23%" class="center">Kategori</th>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="listproject" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_listproject"
                                                    value="<?php echo $r['id_listproject']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="kategori" class="form-control" id="">
                                                        <option value="INDONESIAN PROJECT"
                                                            <?=($r['kategori'] != 'PROJECT ABROAD') ? 'selected' : '' ?>>
                                                            INDONESIAN  PROJECT</option>
                                                        <option value="PROJECT ABROAD"
                                                            <?=($r['kategori'] == 'PROJECT ABROAD') ? 'selected' : '' ?>>
                                                            PROJECT ABROAD</option>
                                                    </select>
                                                </div>
                                        </div>
            ...
            <div class="modal-body">
                <form action="listproject" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul">
                        <!--<textarea rows="10" name="judul" class="form-control"></textarea>-->
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Kategori</label>
                        <select name="kategori" class="form-control" id="">
                            <option value="INDONESIAN PROJECT">INDONESIAN
                                PROJECT</option>
                            <option value="PROJECT ABROAD">PROJECT ABROAD
                            </option>
                        </select>
                    </div>
            </div>
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/listproject/aksi.php?module=<?php echo $module; ?>&act=add"
                    method="POST" enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul listproject <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="listproject" type="hidden" class="form-control"
...
<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM listproject WHERE id_listproject='$_GET[id]'");
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/listproject/aksi.php?module=<?php echo $module; ?>&act=update"
                    method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_listproject" value="<?php echo $tedit['id_listproject']; ?>">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/listproject/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
