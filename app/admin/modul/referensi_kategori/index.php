<?php $this->layout('template', ['hal'=>'Referensi Kategori']) ?>
<?php
	$module = 'kategori-portofolio';
	switch($act){
		case "list":
	?>
<a href="portofolio" class="btn btn-success"> <i class="sl-icon-magic-wand"></i> Refe</a>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="kategori-portofolio" method="POST"
                                                enctype="multipart/form-data">
                                                <input type="hidden" name="id_portofolio_kategori"
                                                    value="<?php echo $r['id_portofolio_kategori']; ?>">
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/portofolio_kategori/aksi.php?module=<?php echo $module; ?>&act=add"
                    method="POST" enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul portofolio_kategori <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="portofolio_kategori" type="hidden" class="form-control"
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/portofolio_kategori/aksi.php?module=<?php echo $module; ?>&act=update"
                    method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_portofolio_kategori"
                        value="<?php echo $tedit['id_portofolio_kategori']; ?>">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/portofolio_kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery"
            method="POST" enctype="multipart/form-data">
