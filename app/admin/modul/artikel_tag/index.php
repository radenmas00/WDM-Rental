<?php $this->layout('template', ['hal'=>'Tags']) ?>
<?php
	$module = 'artikel_tag';
	switch($act){
		case "list":
						...
						?>
							<tr>
								...
								<td align="center" style="width:20%">
									<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#<?php echo $r['id_artikel_tag'] ?>" > <i class="fas fa-pencil-alt"></i> Edit</button>
									<a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');" href="<?php echo $module; ?>-delete-<?php echo $r['id_artikel_tag']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="min-width: 60px;"> <i class="fa fa-trash"></i> Delete</a>
								</td>
							</tr>
						<!-- modal edit content -->
						<div id="<?php echo $r['id_artikel_tag'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="artikel_tag" method="POST" enctype="multipart/form-data">
										<input type="hidden" name="id_artikel_tag" value="<?php echo $r['id_artikel_tag']; ?>">
			...
			<section class="content">
			  <div class="row">
				...
				<div class="col-md-12 card">
				  ...
				  <div class="card-body">
					<!-- form start -->
					<form role="form" action="modul/artikel_kategori/aksi.php?module=<?php echo $module; ?>&act=add" method="POST" enctype="multipart/form-data" >
						<div class="box-body table-responsive">
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1">name artikel_kategori <span title="wajib" style="color: red;">*</span></label>
                                    <input name="artikel_kategori" type="hidden" class="form-control" value="<?php echo $kat_nyan; ?>">
	...
	<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM artikel_kategori WHERE id_artikel_tag='$_GET[id]'");
			  ...
			  <div class="row">
				...
				<div class="col-md-12 card">
				  ...
				  <div class="ccard-body">
					<!-- form start -->
					<form role="form" action="modul/artikel_kategori/aksi.php?module=<?php echo $module; ?>&act=update" method="POST" enctype="multipart/form-data" >
						<input type="hidden" name="id_artikel_tag" value="<?php echo $tedit['id_artikel_tag']; ?>">
						...
						<div class="box-body table-responsive">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1">name artikel_kategori <span title="wajib" style="color: red;">*</span></label>
									<input name="name" type="text" class="form-control" value="<?php echo $tedit['name']; ?>" required>
								</div>
							</div>
			...
			<?php
				...
				?>
						...
						<section class="content">
						  <div class="row">
							<!-- left column -->
							<form role="form" action="modul/artikel_kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST" enctype="multipart/form-data" >
