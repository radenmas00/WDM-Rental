<?php $this->layout('template', ['hal' => 'paketwisata']) ?>
<?php
$module = "paketwisata";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><img src="../images/<?php echo "paketwisata/small/$r[gambar]"; ?>" width="60px">
                                                </td>
                                                <td width="20%" align="center"><?php echo  tgl2($r['tgl']); ?></td>

                                                <td align="center" width="20%">
                                                    <a href="<?php echo $module; ?>-edit-<?php echo $r['id_paketwisata']; ?>" class="btn btn-warning " role="button" aria-pressed="true" style="min-width: 50px;margin-bottom: 5px;"> <i class="fa fa-pencil"></i>
                                                        Edit</a>

                                                    <a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="<?php echo $module; ?>-delete-<?php echo $r['id_paketwisata']; ?>" class="btn btn-danger " role="button" aria-pressed="true" style="min-width: 60px;margin-bottom: 5px;"> <i class="fa fa-trash"></i>
                                                        Delete</a>
                                                </td>
                                            </tr>
                                        <?php
    ...
    ?>
        <section class="content">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                        <form role="form" action="paketwisata" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama Paket Wisata<span title="wajib" style="color: red;">*</span></label>
    ...
    ?>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                        <form id="formyku" role="form" action="paketwisata" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id_paketwisata" id="id_paketwisata" value="<?php echo $data['id_paketwisata'] ?>">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <p style="margin-top: 5px;margin-bottom:0;" class="help-block">*) Ukuran Gambar
                                                Minimal Lebar 1000px dan Tinggi 1000px</p>
                                            <p class="help-block">*) Maksimal Size Gambar 2MB</p>
                                            <img style="height: 150px;" src="../images/paketwisata/<?php echo $data['gambar'] ?>" alt="">
                                        </div>
                                    </div>
