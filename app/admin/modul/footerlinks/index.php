<?php $this->layout('template', ['hal' => 'Footer Links']) ?>
<?php
$module = "footerlinks";
...
switch ($act) {
    case "list":
?>
        <a href="footerlinks-add" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data</a>
        <br><br>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <!-- <td><img src="../images/footerlinks/small/<?php echo $row['gambar']; ?>" style="width:100px;margin:0 auto;display:block"> -->
                            </td>
                            <td style="width:19%"><a href="footerlinks-edit-<?php echo $row['id_link'] ?>" class="btn btn-warning"> <i class="fas fa-pencil-alt"></i> Edit</a>
    ...
    ?>
        <div class="card">
            <div class="card-body">
                <form action="footerlinks" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
    ...
    ?>
        <div class="card">
            <div class="card-body">
                <form action="footerlinks" id="form-gallery" method="POST" enctype="multipart/form-data">
