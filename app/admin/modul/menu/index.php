<?php $this->layout('template', ['hal'=>'Menu']) ?>
<?php
	$module = 'menu';
	switch($act){
		case "list":
                    ...
                    <table id="my_table2" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="23%" class="center">Menu</th>
                                <th width="23%" class="center">Urutan</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="menu" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Urutan</label>
                                                    <input type="number" class="form-control" id="urutan" name="urutan"
                                                        value="<?php echo $r['urutan'] ?>">
                                                </div>
                                                <!-- <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Answer</label>
                                                    <input type="text" class="form-control" id="judul" name="deskripsi"
                                                        value="<?php echo $r['deskripsi'] ?>">
                                                </div> -->
                                        </div>
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/menu/aksi.php?module=<?php echo $module; ?>&act=add" method="POST"
                    enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul menu <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="menu" type="hidden" class="form-control" value="<?php echo $kat_nyan; ?>">
...
<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM menu WHERE id_menu='$_GET[id]'");
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/menu/aksi.php?module=<?php echo $module; ?>&act=update" method="POST"
                    enctype="multipart/form-data">
                    <input type="hidden" name="id_menu" value="<?php echo $tedit['id_menu']; ?>">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/menu/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
            enctype="multipart/form-data">
