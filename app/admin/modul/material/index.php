<?php $this->layout('template', ['hal'=>'Material Furniture']) ?>
<?php
	$module = "material";
                        ...
                        <table id="my_table" class="table table-striped table-bordered">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center"><img src="../images/<?php echo "material/small/$r[gambar]"; ?>"
                                            width="100px">
                                    </td>
                                    <td width="20%" align="center"><?php echo  tgl2($r['tgl']); ?></td>

                                    <td align="center" width="20%">
                                        <a href="<?php echo $module; ?>-edit-<?php echo $r['id_material']; ?>"
                                        ...
                                        <a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');"
                                            href="<?php echo $module; ?>-delete-<?php echo $r['id_material']; ?>"
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 ">
            <div class="card">
                <!-- form start -->
                <form role="form" action="material" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <img style="height: 100px;"
                                        src="../images/material/small/<?php echo $data['gambar'] ?>" alt="">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12" style="margin-bottom:10px">
                                <div class="box-body table-responsive"
                                    ...
                                    <label for="exampleInputFile" id="gallery_material">Gambar Lainnya</label><br>

                                    <a href="referensi-addgallery-<?=$data['id_material']?>"
                                            ...
                                            <div class="col-md-2 col-xs-12"
                                                ...
                                                <div class="photo" style="margin-bottom:10px">
                                                    <a href="#"
                                                        ...
                                                        <img src="../images/gallery_material/small/<?php echo "$tsubpro[gambar]"; ?>"
                                                ...
                                                <div class="d-flex justify-content-center w-100">
                                                    ...
                                                    <a style="margin-top:10px" class="btn btn-danger"
                                                        ...
                                                        href='material-gallery-delete-<?php echo $tsubpro['id_gallery']; ?>-<?php echo $data['id_material']; ?>'>Hapus</a>
                                                </div>
                                            </div>
                                            <?php
                                                endforeach;
        ...
        <div class="col-md-12 card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="idm" value="<?php echo $data['id_material']; ?>">
                    <label for="">Gambar</label>
                    <input type="file" name="lopoFile" class="form-control">
                    <br><br>
                    <img style="height:300px" src="../images/gallery_material/<?php echo $data['gambar']?>">
                    <p style="margin-top: 5px;margin-bottom:0;" class="help-block">*) Ukuran Gambar
                        Minimal Lebar 1062px dan Tinggi 1062px</p>
                </div>
            </div>
