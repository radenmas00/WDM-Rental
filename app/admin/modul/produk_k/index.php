<?php $this->layout('template', ['hal'=>'Kategori Products']) ?>
<?php
	$module = "produk_k";
	switch($act){
        case "list":
...
<a href="produk_k-add" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data</a>
    ...
    <table id="my_table" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <!-- <td>
                    <img src="../images/produk_k/small/<?php echo $row['gambar']; ?>"
                        style="width:100px;margin:0 auto;display:block">
                </td> -->
                <td width="18%" style="width:19%"><a
                        href="produk_k-edit-<?php echo $row['id_produk_k'] ?>" class="btn btn-warning ">
                        <i class="fas fa-pencil-alt"></i> Edit</a>
                    <a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');"
                        href="<?php echo $module; ?>-delete-<?php echo $row['id_produk_k']; ?>"
...
<div class="card">
    <div class="card-body">
        <form action="produk_k" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <button type="submit" id="btn-produk_k" class="btn btn-primary"><i
...
<div class="card">
    <div class="card-body">
        <form action="produk_k" id="form-produk_k" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_produk_k" value="<?php echo $data['id_produk_k'] ?>">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Nama</label>
                ...
                <!-- <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="" id="img-lopo">
                            <img style="height:200px" src="../images/produk_k/<?php echo $data['gambar'] ?>">
                        </div>
                ...
                <input type="submit" id="btn-produk_k" class="btn btn-primary" value="Simpan Data">
            </div>
        </form>
    </div>
</div>
<?php
	...
	case "addgallery":
?>
<form action="modul/produk_k/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
...
<?php
    break;
	case "editgallery":
	$gam =  $db->connection("SELECT * FROM gallery_produk_k WHERE id_gallery = '$_GET[id]'  ")->fetch();
?>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <img style="height:300px"
                        src="../images/gallery_produk_k/<?php echo $imgname2."-".$gam['gambar']?>">
                </div>
            </div>
        </div>
        <input type="submit" class="btn btn-info" value="Simpan Data">
