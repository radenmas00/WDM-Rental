            ...
            if ( ( $ukuran == 0 ) OR ( $ukuran == 02 ) OR ( $ukuran>9060817 ) ) {
                ...
                if ( $res == true ) {
                    try {
                        ...
                        echo "<script>alert('artikel Berhasil diedit'); window.location = 'artikel-edit-$_POST[id_artikel]'</script>";
                    } catch( PDOException $e ) {
                        echo "<script>alert('artikel Gagal diedit!'); window.location = 'artikel-edit-$_POST[id_artikel]'</script>";
                    }
                } else {
                    echo "<script>alert('Something error with this image'); window.location = 'artikel-edit-$_POST[id_artikel]'</script>";
                }
    ...
    elseif (  $act == 'add' ) {
        ...
        if ( $res == false ) {
            ...
            try {
                ...
                $msg->success("artikel berhasil ditambah");
                echo "<script>window.location = 'artikel-edit-$insertId'</script>";


            } catch( PDOException $e ) {
                echo "<script>alert('artikel Gagal diedit!'); window.location = '$hal'</script>";
            }
        }
