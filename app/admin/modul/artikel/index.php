...
?>
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <?php if ($per == 'all') : ?>
                        <button class="btn btn-primary" onclick="window.location.href='artikel-add';"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</button>
                    <?php else : ?>
                        <button class="btn btn-primary" onclick="window.location.href='artikel-add';"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</button>
                    <?php endif; ?>
                                ...
                                <table id="my_table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- <th width="30%" class="center">Kategori </th> -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><img src="../images/<?php echo "artikel/small/$r[gambar]"; ?>" width="180px">
                                                </td>
                                                <td width="20%" align="center"><?php echo  tgl2($r['tgl']); ?></td>

                                                <td align="center" width="20%">
                                                    <a href="artikel-edit-<?php echo $r['id_artikel']; ?>" class="btn btn-warning " role="button" aria-pressed="true" style="min-width: 50px;margin-bottom: 5px;"> <i class="fa fa-pencil"></i> Edit</a>

                                                    <a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="artikel-delete-<?php echo $r['id_artikel']; ?>" class="btn btn-danger " role="button" aria-pressed="true" style="min-width: 60px;margin-bottom: 5px;"> <i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
                    ...
                    <div class="card">
                        ...
                        <form role="form" action="artikel" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <select class="select2 m-b-10 select2-multiple " multiple="multiple"
                                                ...
                                                <?php
                                                foreach ($tag as $row) : ?>
                                                <option value="<?php echo $row['id_artikel_tag'] ?>">
                                                    <?php echo $row['name'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            <a class="btn btn-info" href="artikel_tag"><i class="fa fa-plus"></i> Tag
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name='tgl' type="text" class="form-control fc-datepicker" placeholder="DD/MM/YYYY">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="card-footer pb-5">
                                ...
                                <input type="button" class="mb-2 btn btn-secondary float-right" value="Kembali" onclick="location.href='artikel' ">
                            </div>
                        </form>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Kategori</label>
                                            <select name="tipe" class="form-control">
                                                <option value="Artikel" <?php echo ($data['tipe'] == 'Artikel') ? 'selected' : '' ?>>Artikel</option>
                                                <option value="Berita" <?php echo ($data['tipe'] == 'Berita') ? 'selected' : '' ?>>Berita</option>
                                            </select>
                                        </div>
                                    </div> -->
                                    <!-- <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <select style="width:100%" name="tagNyan"
                                                ...
                                                <option value="<?php echo $row['id_artikel_tag'] ?>" <?php
                                                                                                        foreach ($artikel_tag as $tag) {
                                                                                                            if ($tag['id_tag'] == $row['id_artikel_tag']) {
                                                                                                                echo "selected";
                                                                                                            } else {
                                                                                                                echo "";
                                                                                                            }
                                        ...
                                        <div class="col-md-2">
                                            <a class="btn btn-info" href="artikel_tag-add"><i class="fa fa-plus"></i> Tag </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p style="margin-top: 5px;margin-bottom:0;" class="help-block">*) Ukuran Gambar
                                                Minimal Lebar 750px dan Tinggi 350px</p>
                                            <p class="help-block">*) Maksimal Size Gambar 2MB</p>
                                            <img style="height: 150px;" src="../images/artikel/small/<?php echo $data['gambar'] ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                                                <input type="text" name="tgl" class="form-control fc-datepicker" placeholder="DD/MM/YYYY" value="<?php echo $tangalo ?>">
                                            </div>
                                        </div>
                                    </div>
