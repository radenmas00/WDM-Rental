<?php $this->layout('template', ['hal' => 'Kategori']) ?>
<?php
$module = 'kategori';
switch ($act) {
    case "list":
?>
                            ...
                            <table id="my_table2" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="23%" class="center">Judul</th>
                                        <th width="23%" class="center">Deskripsi</th>
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    while ($r = $dataku->fetch(PDO::FETCH_ASSOC)) {
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center" style="width:20%">
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#<?php echo $r['id_kategori'] ?>"> <i class="fas fa-pencil-alt"></i>
                                                    Edit</button>
                                                <a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');" href="<?php echo $module; ?>-delete-<?php echo $r['id_kategori']; ?>" class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="min-width: 60px;"> <i class="fa fa-trash"></i> Delete</a>
                                            </td>
                                        </tr>
                                        <!-- modal edit content -->
                                        <div id="<?php echo $r['id_kategori'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="kategori" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="" style="width:100%" cols="30" rows="5" name="deskripsi"><?php echo $r['deskripsi']; ?></textarea>
                                                            </div>
                                                    </div>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-12 card">
                    ...
                    <div class="card-body">
                        <!-- form start -->
                        <form role="form" action="modul/kategori/aksi.php?module=<?php echo $module; ?>&act=add" method="POST" enctype="multipart/form-data">
                            <div class="box-body table-responsive">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">judul kategori <span title="wajib" style="color: red;">*</span></label>
                                        <input name="kategori" type="hidden" class="form-control" value="<?php echo $kat_nyan; ?>">
    ...
    <?php
        break;
    case "edit":
        // $edit = $db->connection("SELECT * FROM kategori WHERE id_kategori='$_GET[id]'");
            ...
            <div class="row">
                ...
                <div class="col-md-12 card">
                    ...
                    <div class="ccard-body">
                        <!-- form start -->
                        <form role="form" action="modul/kategori/aksi.php?module=<?php echo $module; ?>&act=update" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id_kategori" value="<?php echo $tedit['id_kategori']; ?>">
    ...
    ?>
        ...
        <section class="content">
            <div class="row">
                <!-- left column -->
                <form role="form" action="modul/kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST" enctype="multipart/form-data">
