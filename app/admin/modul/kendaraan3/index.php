                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><img src="../images/<?php echo "kendaraan3/small/$r[gambar]"; ?>" width="60px">
                                                </td>
    ...
    ?>
        <section class="content">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                        <form role="form" action="kendaraan3" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
    ...
    ?>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                        <form id="formyku" role="form" action="kendaraan3" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <p style="margin-top: 5px;margin-bottom:0;" class="help-block">*) Ukuran Gambar
                                                Minimal Lebar 1000px dan Tinggi 1000px</p>
                                            <p class="help-block">*) Maksimal Size Gambar 2MB</p>
                                            <img style="height: 150px;" src="../images/kendaraan3/<?php echo $data['gambar'] ?>" alt="">
                                        </div>
                                    </div>
