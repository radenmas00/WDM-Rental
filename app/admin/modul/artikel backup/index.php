...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php else : ?>
                <button class="btn btn-primary" onclick="window.location.href='<?php echo $urk; ?>-add';"><i
                    class="fa fa-plus" aria-hidden="true"></i> Tambah Data</button>
            <?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="Info"
                                            <?php echo ($data['status'] == 'Info')? 'selected' : '' ?>>Info
                                        </option>
                                        <option value="News"
                                            <?php echo ($data['status'] == 'News')? 'selected' : '' ?>>News</option>
                                    </select>
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
