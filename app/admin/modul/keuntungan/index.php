<?php $this->layout('template', ['hal'=>'Angka']) ?>
<?php
	$module = 'keuntungan';
	switch($act){
		case "list":
                    ...
                    <table id="my_table2" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <!-- <th width="23%" class="center">Icon</th> -->
						...
						?>
                            <tr>
                                ...
                                <td><?=  $r['judul']; ?></td>
                                <td><?=  $r['deskripsi']; ?></td>
                                <!-- <td><i class="<?php echo  $r['gambar']; ?>" > </i></td> -->
                                <td align="center" style="width:20%">
                                    <button type="button" class="btn btn-warning" data-toggle="modal"
                                        data-target="#<?php echo $r['id_keuntungan'] ?>"> <i
                                            class="fas fa-pencil-alt"></i> Edit</button>
                                     <!--<a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');"-->
                                     <!--   href="<?php echo $module; ?>-delete-<?php echo $r['id_keuntungan']; ?>"-->
                                     <!--   class="btn btn-danger btnadmin" role="button" aria-pressed="true"-->
                                     <!--   style="min-width: 60px;"> <i class="fa fa-trash"></i> Delete</a> -->
                                </td>
                            </tr>
                            <!-- modal edit content -->
                            <div id="<?php echo $r['id_keuntungan'] ?>" class="modal fade" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="keuntungan" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_keuntungan"
                                                    value="<?php echo $r['id_keuntungan']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="deskripsi" class="form-control ninjin"
                                                        rows="4"><?php echo $r['deskripsi'] ?></textarea>
                                                </div>
                                                <!-- <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Icon</label>
                                                    <br>
                                                    <?php foreach($icons as $i) : ?>
                                                    <input type="radio" id="<?=$i['nama']?>" name="gambar"
                                                        value="<?=$i['nama']?>" required
                                                        <?= ($i['nama'] == $r['gambar'])? 'checked' : '' ?>>
                                                    <label for="<?=$i['nama']?>"><i style="font-size:16px"
                                                            class="<?=$i['nama']?> mr-3"></i></label>
                                                    <?php endforeach ?>
                                                </div> -->
                                        </div>
...
<!-- modal add keuntungan_kategori content -->
            ...
            <div class="modal-body">
                <form action="keuntungan" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <br>
                        <?php foreach($icons as $i) : ?>
                        <input type="radio" id="<?=$i['nama']?>" name="gambar" value="<?=$i['nama']?>" required>
                        <label for="<?=$i['nama']?>"><i style="font-size:16px" class="<?=$i['nama']?> mr-3"></i></label>
                        <?php endforeach ?>
                    </div> -->
            </div>
            <div class="modal-footer">
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/keuntungan_kategori/aksi.php?module=<?php echo $module; ?>&act=add"
                    method="POST" enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul keuntungan_kategori <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="keuntungan_kategori" type="hidden" class="form-control"
...
<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM keuntungan_kategori WHERE id_keuntungan='$_GET[id]'");
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/keuntungan_kategori/aksi.php?module=<?php echo $module; ?>&act=update"
                    method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_keuntungan"
                        value="<?php echo $tedit['id_keuntungan']; ?>">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/keuntungan_kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery"
            method="POST" enctype="multipart/form-data">
