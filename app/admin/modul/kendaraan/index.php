                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><img src="../images/<?php echo "kendaraan/small/$r[gambar]"; ?>" width="60px">
                                                </td>
    ...
    ?>
        <section class="content">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                        <form role="form" action="kendaraan" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Harga / 12 Jam</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Harga / 24 Jam</label>
                                            <input name="harga2" type="number" class="form-control">
                                        </div>
                                    </div>
    ...
    ?>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                        <form id="formyku" role="form" action="kendaraan" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Harga / 24 Jam</label>
                                            <input name="harga2" type="number" class="form-control" value="<?php echo $data['harga2'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <p style="margin-top: 5px;margin-bottom:0;" class="help-block">*) Ukuran Gambar
                                                Minimal Lebar 1000px dan Tinggi 1000px</p>
                                            <p class="help-block">*) Maksimal Size Gambar 2MB</p>
                                            <img style="height: 150px;" src="../images/kendaraan/<?php echo $data['gambar'] ?>" alt="">
                                        </div>
                                    </div>
