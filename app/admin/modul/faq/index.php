<?php $this->layout('template', ['hal'=>'FAQ']) ?>
<?php
	$module = 'faq';
	switch($act){
		case "list":
                    ...
                    <table id="my_table2" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="23%" class="center">Question</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="faq" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_faq" value="<?php echo $r['id_faq']; ?>">
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/faq/aksi.php?module=<?php echo $module; ?>&act=add" method="POST"
                    enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul faq <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="faq" type="hidden" class="form-control" value="<?php echo $kat_nyan; ?>">
...
<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM faq WHERE id_faq='$_GET[id]'");
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/faq/aksi.php?module=<?php echo $module; ?>&act=update" method="POST"
                    enctype="multipart/form-data">
                    <input type="hidden" name="id_faq" value="<?php echo $tedit['id_faq']; ?>">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/faq/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
            enctype="multipart/form-data">
