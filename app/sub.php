            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-start">
                    ...
                    <li class="breadcrumb-item text-nowrap"><a
                            href="kategori-<?=$dk['judul_seo']."-".$dk['id_produk_k']?>"><?=$dk['judul']?></a>
                    </li>
                    <li class="breadcrumb-item text-nowrap active" aria-current="page"><?=$data['judul']?></li>
                </ol>
            </nav>
        </div>
        <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 class="h3 mb-0"><?=$data['judul']?></h1>
        </div>
    </div>
</div>
                                ...
                                <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                    ...
                                    <div class="simplebar-content" style="padding: 4px 0px;">
                                        ...
                                        <div class="widget widget-links">
                                            <h3 class="widget-title d-none d-lg-block">Sub Kategori Lainnya</h3>
                                            <ul class="widget-list">
                                                <?php foreach($sub as $r) : ?>
                                                <li class="widget-list-item"><a class="widget-list-link"
                                                        href="sub-kategori-<?=$r['id_produk_sk']?>"><i
