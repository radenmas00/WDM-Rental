...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style="background: linear-gradient(rgba(19, 58, 98, .9), rgba(19, 58, 98, .9)), url(images/page-header.jpg) center center; background-size: cover;">
    <div class="container py-5">
        <h1 class="display-4 animated slideInDown mb-4">Properti</h1>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-7 wow fadeInUp ps-0" data-wow-delay="0.5s">
                <div class="heading-section mb-5 heading-section-with-line">
                    <span class="subheading ms-4">PRODUK & PELAYANAN - PROPERTI</span>
                </div>
    ...
    <div class="container">
        <div class="row mb-5 pb-3 justify-content-center">
            <div class="col-md-9 heading-section heading-section-with-line">
                ...
                <small class="text-muted">Menampilkan <?= $jmlproperti ?> properti yang tersedia.</small>
            </div>
        </div>
        <div class="row g-4">
            <?php foreach ($properti as $row) : ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp d-flex align-items-stretch" data-wow-delay="0.1s">
                    <div class="card rounded-0 shadow w-100 border-0 h-100">
                        <a href="properti-<?= $row['judul_seo'] . "-" . $row['id_properti'] ?>"><img src="images/properti/<?= $row['gambar'] ?>.webp" class="card-img-top rounded-0" alt="..." style="aspect-ratio:4/3; object-fit:cover; object-position:center;"></a>
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><a href="properti-<?= $row['judul_seo'] . "-" . $row['id_properti'] ?>"><?= $row['judul'] ?></a></h5>
                            ...
                            <div class="text-blue-primary fw-bold mb-2"><?= $row['harga'] ?></div>
                            <p class="card-text"><?= limit_desc($row['deskripsi'], 100) ?> ...</p>
                            <div class="mt-auto">
                                <hr>
                                <a href="properti-<?= $row['judul_seo'] . "-" . $row['id_properti'] ?>" class="btn btn-blue-outline px-4">Lihat Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
