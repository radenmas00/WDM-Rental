    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 wow fadeInUp pe-lg-4" data-wow-delay="0.1s">
                <img src="images/penerbit/<?= $data['gambar'] ?>" alt="" class="img-fluid w-100 mb-4">
                ...
                <div class="bg-light p-4 rounded">
                    <h5 class="text-blue-primary">Sudah siap menerbitkan karya spesial anda bersama kami?</h5>
                    <p>Silahkan klik tombol di bawah ini untuk informasi lebih lanjut</p>
                    <a href="https://api.whatsapp.com/send?phone=<?= $deskrip[7] ?>&text=Halo <?= $namaweb ?>, Saya mau ingin informasi lebih lanjut tentang jasa penerbitan." target="_blank" class="btn btn-blue-outline px-5"><i class="fab fa-whatsapp"></i> Hubungi Kami</a>
                </div>
                <hr>
            ...
            <div class="col-lg-4 wow fadeInUp pt-0 px-sm-0 ms-sm-0 me-sm-0" data-wow-delay="0.5s">
                <div class="sidebar-box shadow">
                    <h3 class="text-blue-primary">Terbitan Lainnya</h3>
                    <?php foreach ($penerbit as $row) : ?>
                        <div class="block-21 mb-4 d-flex justify-content-between">
                            <a href="penerbit-<?= $row['judul_seo'] . "-" . $row['id_penerbit'] ?>" class="blog-img mr-4" style="background-image: url(images/penerbit/<?= $row['gambar'] ?>.webp);"></a>
                            <div class="text justify-content-between">
                                <h3 class="heading"><a href="penerbit-<?= $row['judul_seo'] . "-" . $row['id_penerbit'] ?>"><?= $row['judul'] ?></a></h3>
                                <div class="meta">
