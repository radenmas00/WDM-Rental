...
<div class="container-fluid bg-primary">
    <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
        <h3 class="display-4 font-weight-bold text-white">TK (Taman Kanak-Kanak)</h3>
        <div class="d-inline-flex text-white">
            <p class="m-0"><a class="text-white" href="<?php echo $base_url ?>">Home</a></p>
            <p class="m-0 px-2">/</p>
            <p class="m-0">TK (Taman Kanak-Kanak)</p>
        </div>
    </div>
</div>
<!-- Header End -->
            ...
            <div class="col-lg-5 mb-4 mb-lg-0">
                <div class="row h-100">
                    <div class=" col-12 p-2 d-flex flex-column text-center">
                        <div class="shadow-sm rounded w-100 embed-responsive embed-responsive-1by1" style="background-image: url('assets/theme/img/about-1.jpg'); background-size : cover; background-position : center center;"></div>
                        <h4 class="mt-4">Kepala Sekolah</h4>
                        <div class="display-5 font-weight-bold">H. Sucipto, S.Pd</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
...
<div class="container-fluid py-5">
    <div class="container p-0 text-center">
        ...
        <div class="small mt-4">Menampilkan 6 dari 10 berita yang tersedia</div>
        <a href="" class="btn btn-transparent-primary px-5 py-2 my-2">Lihat Berita Selengkapnya <i class="bi-arrow-right-short"></i></a>
    </div>
</div>
<!-- Berita End -->
